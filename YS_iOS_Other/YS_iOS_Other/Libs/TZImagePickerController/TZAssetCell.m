...
- (UIImageView *)selectImageView {
    if (_selectImageView == nil) {
        ...
        selectImageView.frame = CGRectMake(self.tz_width - 25 - 4, 4, 25, 25);
...
- (void)setModel:(TZAlbumModel *)model {
    ...
    NSMutableAttributedString *nameString = [[NSMutableAttributedString alloc] initWithString:model.name attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:17],NSForegroundColorAttributeName:[UIColor blackColor]}];
    NSAttributedString *countString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"  (%zd)",model.count] attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17],NSForegroundColorAttributeName:UIColorFromRGB(0x878787)}];
...
//    _selectedCountButton.frame = CGRectMake(self.tz_width - 24 - 30, 23, 24, 24);
    _selectedCountButton.frame = CGRectMake(self.tz_width - 24 - 30, (113/2-24)/2, 24, 24);
}
...
- (UIImageView *)posterImageView {
    if (_posterImageView == nil) {
        ...
        posterImageView.image = [UIImage imageNamedFromMyBundle:@"photo_album_placehold"];
        posterImageView.contentMode = UIViewContentModeScaleAspectFill;
        posterImageView.clipsToBounds = YES;
//        posterImageView.frame = CGRectMake(0, 0, 70, 70);
        posterImageView.frame = CGRectMake(0, 0, 113/2, 113/2);
...
//        titleLabel.frame = CGRectMake(80, 0, self.tz_width - 80 - 50, self.tz_height);
        titleLabel.frame = CGRectMake(130/2, 0, self.tz_width - 130/2 - 50, 113/2);
