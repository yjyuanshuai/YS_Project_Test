...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _imageView.contentMode = UIViewContentModeScaleAspectFill;//UIViewContentModeScaleAspectFit;
        ...
        [_deleteBtn setImage:[UIImage imageNamed:@"healthRecord_image_clear"] forState:UIControlStateNormal];
...
{
    if (_recordDeleteBlock) {
        _recordDeleteBlock(btn.tag - DeleteImageBtnTag);
    }
}

- (void)setImage:(id)imageModel
        ...
        showMore:(BOOL)showMore
{
    ...
    _deleteBtn.tag = DeleteImageBtnTag + indexPath.row;
    _moreLabel.hidden = !showMore;
}
