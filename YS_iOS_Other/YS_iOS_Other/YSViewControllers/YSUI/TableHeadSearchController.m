...
@interface TableHeadSearchController ()<UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UISearchResultsUpdating, UISearchControllerDelegate>
...
@implementation TableHeadSearchController
{
...
{
    _historyArr = [[[NSUserDefaults standardUserDefaults] objectForKey:SearchHistoryKey] mutableCopy];
